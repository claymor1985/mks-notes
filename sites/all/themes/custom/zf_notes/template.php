 ...
 * Preprocess node.
 */
function zf_notes_preprocess_node(&$variables) {
  $preprocess_entity_loaded = &drupal_static('zf_notes_preprocess_entity_loaded', FALSE);
  $node = &$variables['node'];
  ...
  if (!$preprocess_entity_loaded) {
    ...
    $file = path_to_theme() . '/zf_notes.preprocess_entity.inc';
    if (is_file($file)) {
      require_once $file;
    }
  }
  // Run specific preprocess function.
  $preprocess = 'zf_notes_preprocess_node_' . $node->type . '__' . $view_mode;
 ...
 * Theme field.
 */
function zf_notes_field(&$variables) {
 ...
 *
 */
//function zf_notes_preprocess_html(&$variables) {
 ...
 *
 */
//function zf_notes_preprocess_page(&$variables) {
//}
 ...
 */
//function zf_notes_preprocess_block(&$variables) {
...
//function zf_notes_preprocess_views_view(&$variables) {
//}
 ...
 *
 */
//function zf_notes_preprocess_panels_pane(&$variables) {
//}
 ...
 *
 */
//function zf_notes_preprocess_views_view_fields(&$variables) {
//}
 ...
 */
//function zf_notes_form_element_label($variables) {
 ...
 */
//function zf_notes_preprocess_button(&$variables) {
 ...
 */
//function zf_notes_form_alter(&$form, &$form_state, $form_id) {
//  // Sexy submit buttons
 ...
 */
//function zf_notes_form_comment_form_alter(&$form, &$form_state) {
 ...
 */
//function zf_notes_css_alter(&$css) {
